...
## [Compile the Mars App Daemon](../../develop/mars-cli/marsd)
...
## Initialise Mars Node

Running this command creates your consensus key, node key, as well as some config files for your node:
...
For testnet, the chain-id is ares-1. 
</Admonition>
