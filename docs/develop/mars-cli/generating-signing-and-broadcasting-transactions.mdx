...
- fetch `$MY_NODE_ADDRESS` from the keyring. This is possible if you have set you have set up the CLI's keyring (from a separate [tutorial](../../infrastructure/validators/key-management/setting-up-keyring)).
