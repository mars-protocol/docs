...
- agree that the Site is provided for informational purposes only and is not directly or indirectly in control of or capable of interacting with Mars Hub and related blockchain systems or performing or effecting any transactions on your behalf;
...
- tokens that exist and have been or may be made available by third parties known as “lenders” or “depositors” in connection with the Mars Smart Contract System;
...
- “Mars Smart Contract System” means all blockchain-based runtime bytecodes (aka “smart contracts”) about which the Site provides information, and includes, without limitation, the runtime bytecodes deployed to the Osmosis network addresses listed in the JSON file at https://github.com/mars-protocol/outposts/tree/master/scripts/deploy/addresses (as such file is updated from time to time), which are incorporated herein by reference.
- “Site” means the web site, web pages, web applications and information and software available at or accessible through the URL https://marsprotocol.io/ or any sub-URL of such URL.
...
- “Mars Hub Validators” means, at each time, the Mars Core Nodes included in the active validator set for Mars Hub at such time. As of the date of these Terms, the Mars Hub Validators are the top 130 Mars Core Nodes (ranked by number of $MARS staked).
...
The Mars Smart Contract Protocol will be available in various repositories at https://github.com/mars-protocol/, including https://github.com/mars-protocol/hub, and will be freely licensed under the applicable license set forth in each such repository.
