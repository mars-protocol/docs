...
In view of the importance of data privacy, and our obligations of transparency, we provide information below about cookies, how we use them on our website. For the other information concerning data processing conducted by Delphi Labs Ltd please refer to our [privacy policy](./privacy-policy).
...
| Cookie Key  | Used On  | Domain  | Cookie Type  | Descriptioin  |
|:----:|:----:|:----:|:----:| :----:|
| SIDCC  | faucet.marsprotocol.io  | www.google.com  | Third party cookie  | Strictly necessary  |
| GRECAPTCHA  | faucet.marsprotocol.io  | www.google.com  | Third party cookie  | Strictly necessary  |
| DV  | faucet.marsprotocol.io  | www.google.com  | Third party cookie  | Strictly necessary  |
| OTZ  | faucet.marsprotocol.io  | www.google.com  | Third party cookie  | Strictly necessary  |
| NEXT_LOCALE  |testnet-explorer.marsprotocol.io, explorer.marsprotocol.io  | testnet-explorer.marsprotocol.io, explorer.marsprotocol.io  | Third party cookie  | Strictly necessary  |
| _vercel_jwt  | testnet-osmosis.marsprotocol.io  | testnet-osmosis.marsprotocol.io  | Third party cookie  | Strictly necessary  |
| _cfruid  | .marsprotocol.io  | .marsprotocol.io  | Third party cookie  | Strictly necessary  |
| cf_use_ob, .marsprotocol.io  | .marsprotocol.io  | marsprotocol.io  | Third party cookie  | Strictly necessary  |
| _cflb, _cf_bm, cf_ob_info  |.marsprotocol.io  | .marsprotocol.io  | Third party cookie  | Strictly necessary  |
