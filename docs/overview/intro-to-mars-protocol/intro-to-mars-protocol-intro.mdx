...
1. **Mars Hub:** a Cosmos SDK chain that administers activity occuring on its outposts. Specifically, it does not hold liquidity for outposts but rather governs all outpost smart contracts, receives fees from outposts, and distributes fees to participants in Mars' governance. 
