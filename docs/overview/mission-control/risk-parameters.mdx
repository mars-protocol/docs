...
**safety_tax_rate** = 50%. Meaning 10% of total interest payments (50% of protocol fees) go to the Safety Fund and the reamining 10% go to stakers.

**slippage_tolerance** = 1%. Meaning whenever interest payments are swapped into USDC and MARS, the max slippage allowed for the tx would be 1%.
