...
Validator participation on the Mars Hub testnet and mainnet is encouraged. Validator onboarding documentation is available [here](../../join-the-network/category/validators).