...
here's some of the tweet text if you want to add any of it to the docs @dinodelao... Both Mars v1 and Mars v2 co-exist on-chain. If you previously held Farm Vault positions on Mars v1, they’ve been automatically upgraded to Mars v2 credit accounts. However, if you borrowed or loaned assets within the Red Bank, you’ll need to manually migrate your Red Bank positions to Mars v2. 
