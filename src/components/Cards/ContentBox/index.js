  ...
  if (props.title == 'Getting Started') {
    ...
    return (
      <div className={styles.box}>
        ...
        <a className={styles.links} href="../../../docs/validate/category/node-operators">
          <Box 
            ...
            list={boxProps.validate.nodeOperators.list}
          />
        </a>

        <a className={styles.links} href="../../../docs/validate/category/validators">
          <Box 
            ...
            list={boxProps.validate.validators.list}
          />
        </a>

        <a className={styles.links} href="../../../docs/validate/category/ibc-relayers">
          <Box 
            ...
            list={boxProps.validate.relayers.list}
          />
        </a>
